 ...
 * @LastEditTime: 2023-05-11 13:39:58
...
var icon: UIconType; // https://vkuviewdoc.fsq.pub/components/icon.html
var button: UButtonType;
  ...
  (val) => {
    switch (val) {
      case UXComponentTypeEnum.icon:
        icon = hookViewConfigProps<UIconType>(props.config?.props as UIconType);
        log("uview-icon参数", icon);
        break;
      case UXComponentTypeEnum.button:
        button = hookViewConfigProps<UButtonType>(
