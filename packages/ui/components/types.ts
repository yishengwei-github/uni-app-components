 ...
 * @LastEditTime: 2023-05-06 09:31:23
...
export type MescrollUpOpsType = {
    ...
    /**
     * 默认值true
     * 是否在初始化完毕之后自动执行一次上拉加载的回调,当配置为false时,
     * 建议down的auto也为false,因为downCallback默认调用resetUpScroll,
     ...
     * 是否允许橡皮筋回弹效果, 默认不允许; 
     * 1.1.5新增，1.3.0版本已废弃, 
     * 已通过renderjs自动判断, 无需配置mescroll-touch
     */
    isBounce: boolean,
    /**
